    ...
    >
      <div class="container-max text-center">
        ...
        <p class="text-xl text-primary-100">
          Join I-90's premier restaurant directory and reach hungry travelers
        </p>
      </div>
    </section>
        ...
        <div class="card p-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
            ...
            <div
              ...
              :class="{
                'border-primary-500 bg-primary-50': selectedPlan === 'basic',
              }"
            >
              ...
              <button
                ...
                class="w-full py-2 px-4 rounded-lg border-2 transition-colors"
                :class="
                  selectedPlan === 'basic'
            ...
            <!-- Premium Plan -->
            <div
              class="border-2 border-accent-500 rounded-xl p-6 relative"
              :class="{ 'bg-accent-50': selectedPlan === 'premium' }"
            >
              ...
              <div class="text-center mb-4">
                ...
                <div class="text-3xl font-bold text-accent-600 mt-2">
                  $19.99
                </div>
                <div class="text-gray-600">per month</div>
              </div>
              <ul class="space-y-2 mb-6">
                ...
                <li class="flex items-center">
                  ...
                  Photo gallery & detailed description
                </li>
                <li class="flex items-center">
                  <svg
                    class="w-5 h-5 text-green-500 mr-3"
              ...
              <button
                ...
                :class="
                  selectedPlan === 'premium'
                    ...
                    : 'border-accent-300 text-accent-700 hover:border-accent-400'
                "
              >
                Select Premium
              </button>
          ...
          <form @submit.prevent="handleSignup" class="space-y-6">
            ...
            <div>
              ...
              <select
                ...
                class="input-field"
              >
                <option value="">Select your I-90 location</option>
                <option
            ...
            <div>
              <label class="flex items-start">
                ...
                <span class="ml-3 text-sm text-gray-700">
                  ...
                  >. I understand billing will begin immediately.
                </span>
              </label>
            </div>
...
const handleSignup = async () => {
  ...
  try {
    const { data } = await $fetch("/api/business/signup", {
      method: "POST",
      body: {
        ...form.value,
        ...
        priceId:
          selectedPlan.value === "premium"
            ? "price_business_premium"
            : "price_business_basic",
      },
    });
