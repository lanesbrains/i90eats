  ...
  <div>
    ...
    <section class="relative bg-gray-900 text-white py-20 overflow-hidden">
      ...
      <div class="relative z-10 container-max text-center px-4">
        ...
        <h1 class="text-4xl md:text-5xl font-bold mb-4">List Your Restaurant</h1>
        <p class="text-xl md:text-2xl text-white/90 max-w-3xl mx-auto">Join I-90's premier restaurant directory and reach hungry travelers</p>
      </div>
    </section>
