...
import { b as useNuxtApp, e as asyncDataDefaults, c as createError, a as useRuntimeConfig, f as useRequestEvent } from './server.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-CEQRgrzE.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-CvoIjgeB.mjs.map
