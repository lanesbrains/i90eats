...
const _imports_0 = publicAssetsURL("/i90-bg.jpg");
const _sfc_main = {
  __name: "index",
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)}><section class="relative bg-gray-800 text-white py-20 overflow-hidden"><img${ssrRenderAttr("src", _imports_0)} class="absolute inset-0 w-full h-full object-cover opacity-70" alt="I-90 Background" loading="eager"><div class="absolute inset-0 bg-black bg-opacity-40"></div><div class="relative z-10 container-max text-center px-4"><h1 class="text-5xl font-bold mb-6">I-90 Restaurant Deals</h1><p class="text-xl text-primary-100 mb-8 max-w-3xl mx-auto"> Discover exclusive restaurant deals along Interstate 90 from Seattle to Boston. Get weekly newsletters with local dining specials and save money on great food. </p><div class="flex flex-col sm:flex-row gap-4 justify-center">`);
...
//# sourceMappingURL=index-CWaA_U7g.mjs.map
