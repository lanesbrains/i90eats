...
import { b as useNuxtApp, e as asyncDataDefaults, c as createError, a as useRuntimeConfig } from './server.mjs';
import { O as withBase, w as withLeadingSlash, s as joinURL, v as withoutTrailingSlash } from '../nitro/nitro.mjs';
import { h as hash } from '../_/index.mjs';
import { u as useRequestEvent, a as useContentPreview } from './preview-MyfrdUu7.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-B67fnaT9.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-DkcKZgg4.mjs.map
